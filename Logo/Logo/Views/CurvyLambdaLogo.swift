...
class CurvyLambdaLogo: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            let roundedMainRect = CGPath(roundedRect: mainRect, cornerWidth: topCornerRadius, cornerHeight: topCornerRadius, transform: nil)
            context.addPath(roundedMainRect)
            ...
            context.closePath()
            let bottomTriangle = context.path
            ...
            context.beginPath()
            context.addPath(CGPath(roundedRect: CGRect(x: mainRect.minX, y: mainRect.minY, width: mainRect.width, height: heightToCutoff), cornerWidth: topCornerRadius, cornerHeight: topCornerRadius, transform: nil))
            context.drawPath(using: .fillStroke)
        }
    }
