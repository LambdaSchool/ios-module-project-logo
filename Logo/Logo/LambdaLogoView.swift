...
class LambdaLogoView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        if let context = UIGraphicsGetCurrentContext() {
            ...
            let leftLogoCorner = CGPoint(x: rectangle.midX - 85, y: rectangle.midY + 75)
            ...
            context.addLine(to: CGPoint(x: rectangle.midX + 20, y: rectangle.midY - 35))
            let rightLogoCorner = CGPoint(x: rectangle.midX + 85, y: rectangle.midY + 75)
            context.addLine(to: CGPoint(x: rectangle.midX + 85, y: rectangle.midY + 65))
            context.addQuadCurve(to: CGPoint(x: rectangle.midX + 75, y: rectangle.midY + 75), control: rightLogoCorner)
            context.addLine(to: CGPoint(x: rectangle.midX + 50, y: rectangle.midY + 75))
